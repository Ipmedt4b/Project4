...
public class Humanresources_model4 extends ListActivity {
    ...
    private static String url_all_humanresoures1 = "http://jellescheer.nl/williebrordardus/get_all_humanresources_m3.php";
...
//         Get listview
    ...
    class LoadAllhumanresoures1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Humanresources_model4.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Humanresources_model4.this, humanresoures1List,
