...
public class Humanresources_model1 extends ListActivity {
    ...
    private static String url_all_humanresoures1 = "http://jellescheer.nl/williebrordardus/get_all_humanresources.php";
...
//         Get listview
    ...
    class LoadAllhumanresoures1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Humanresources_model1.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Humanresources_model1.this, humanresoures1List,
