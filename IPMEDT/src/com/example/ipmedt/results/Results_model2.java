...
public class Results_model2 extends ListActivity {
    ...
    private static String url_all_results1 = "http://jellescheer.nl/williebrordardus/get_all_results_m1.php";
...
//    }
    ...
    class LoadAllresults1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Results_model2.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Results_model2.this, results1List,
