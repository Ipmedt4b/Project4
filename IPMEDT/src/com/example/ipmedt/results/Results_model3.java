...
public class Results_model3 extends ListActivity {
    ...
    ArrayList<HashMap<String, String>> results1List;
 
    // url to get all products list
    private static String url_all_results1 = "http://jellescheer.nl/williebrordardus/get_all_results_m2.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        results1List = new ArrayList<HashMap<String, String>>();
 
        // Loading products in Background Thread
        new LoadAllresults1().execute();
...
//    }
     ...
     * */
    class LoadAllresults1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Results_model3.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_results1, "GET", params);
            ...
            try {
                ...
                if (success == 1) {
                	...
                	results1 = json.getJSONArray(TAG_RESULTS);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Results_model3.this, results1List,
