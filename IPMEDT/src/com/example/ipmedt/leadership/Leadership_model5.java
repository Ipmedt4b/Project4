...
public class Leadership_model5 extends ListActivity {
    ...
    private static String url_all_leadership1 = "http://jellescheer.nl/williebrordardus/get_all_leadership_m4.php";
...
//    }
    ...
    class LoadAllleadership1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Leadership_model5.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Leadership_model5.this, leadership1List,
