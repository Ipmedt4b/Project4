...
public class Leadership_model8 extends ListActivity {
    ...
    private static String url_all_leadership1 = "http://jellescheer.nl/williebrordardus/get_all_leadership_m7.php";
...
//         Get listview
    ...
    class LoadAllleadership1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Leadership_model8.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Leadership_model8.this, leadership1List,
