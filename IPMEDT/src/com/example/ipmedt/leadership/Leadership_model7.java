...
public class Leadership_model7 extends ListActivity {
    ...
    ArrayList<HashMap<String, String>> leadership1List;
 
    // url to get all products list
    private static String url_all_leadership1 = "http://jellescheer.nl/williebrordardus/get_all_leadership_m6.php";
 
    // JSON Node names
    private static final String TAG_SUCCESS = "success";  
    private static final String TAG_LEADERSHIP = "leadership";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        leadership1List = new ArrayList<HashMap<String, String>>();
 
        // Loading products in Background Thread
        new LoadAllleadership1().execute();
...
//    }
     ...
     * */
    class LoadAllleadership1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Leadership_model7.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_leadership1, "GET", params);
            ...
            try {
                ...
                if (success == 1) {
                	...
                	leadership1 = json.getJSONArray(TAG_LEADERSHIP);
 
                    // looping through All Products
                    for (int i = 0; i < leadership1.length(); i++) {
                        JSONObject c = leadership1.getJSONObject(i);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Leadership_model7.this, leadership1List,
