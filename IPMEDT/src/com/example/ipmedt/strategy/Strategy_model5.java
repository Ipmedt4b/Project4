...
public class Strategy_model5 extends ListActivity {
    ...
    private static String url_all_strategy1 = "http://jellescheer.nl/williebrordardus/get_all_strategy_m4.php";
...
//         Get listview
    ...
    class LoadAllstrategy1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Strategy_model5.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Strategy_model5.this, strategy1List,
