...
public class Strategy_model8 extends ListActivity {
    ...
    private static String url_all_strategy1 = "http://jellescheer.nl/williebrordardus/get_all_strategy_m7.php";
...
//    }
    ...
    class LoadAllstrategy1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Strategy_model8.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Strategy_model8.this, strategy1List,
