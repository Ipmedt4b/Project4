...
public class Strategy_model7 extends ListActivity {
    ...
    private static String url_all_strategy1 = "http://jellescheer.nl/williebrordardus/get_all_strategy_m6.php";
...
//         Get listview
    ...
    class LoadAllstrategy1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Strategy_model7.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Strategy_model7.this, strategy1List,
