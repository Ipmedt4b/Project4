...
public class Innovation_model1 extends ListActivity {
    ...
    private static String url_all_innovation1 = "http://jellescheer.nl/williebrordardus/get_all_innovation.php";
...
//    }
    ...
    class LoadAllinnovation1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Innovation_model1.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Innovation_model1.this, innovation1List,
