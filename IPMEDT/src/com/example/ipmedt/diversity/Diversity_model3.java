...
public class Diversity_model3 extends ListActivity {
    ...
    private static String url_all_diversity1 = "http://jellescheer.nl/williebrordardus/get_all_diversity_m2.php";
...
//         Get listview
    ...
    class LoadAlldiversity1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Diversity_model3.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Diversity_model3.this, diversity1List,
