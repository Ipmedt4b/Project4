...
public class Diversity_model10 extends ListActivity {
    ...
    ArrayList<HashMap<String, String>> diversity1List;
 
    // url to get all products list
    private static String url_all_diversity1 = "http://jellescheer.nl/williebrordardus/get_all_diversity_m9.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        diversity1List = new ArrayList<HashMap<String, String>>();
 
        // Loading products in Background Thread
        new LoadAlldiversity1().execute();
...
//         Get listview
     ...
     * */
    class LoadAlldiversity1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Diversity_model10.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_diversity1, "GET", params);
            ...
            try {
                ...
                if (success == 1) {
                	...
                	diversity1 = json.getJSONArray(TAG_DIVERSITY);
 
                    // looping through All Products
                    for (int i = 0; i < diversity1.length(); i++) {
                        JSONObject c = diversity1.getJSONObject(i);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Diversity_model10.this, diversity1List,
