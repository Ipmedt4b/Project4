...
public class Diversity_model5 extends ListActivity {
    ...
    private static String url_all_diversity1 = "http://jellescheer.nl/williebrordardus/get_all_diversity_m4.php";
...
//         Get listview
    ...
    class LoadAlldiversity1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Diversity_model5.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Diversity_model5.this, diversity1List,
