...
public class Customer_model9 extends ListActivity {
    ...
    private static String url_all_customer1 = "http://jellescheer.nl/williebrordardus/get_all_customer_m8.php";
...
//    }
    ...
    class LoadAllcustomer1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Customer_model9.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Customer_model9.this, customer1List,
