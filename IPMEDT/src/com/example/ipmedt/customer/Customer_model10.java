...
public class Customer_model10 extends ListActivity {
    ...
    ArrayList<HashMap<String, String>> customer1List;
 
    // url to get all products list
    private static String url_all_customer1 = "http://jellescheer.nl/williebrordardus/get_all_customer_m9.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        customer1List = new ArrayList<HashMap<String, String>>();
 
        // Loading products in Background Thread
        new LoadAllcustomer1().execute();
...
//         Get listview
     ...
     * */
    class LoadAllcustomer1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Customer_model10.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_customer1, "GET", params);
            ...
            try {
                ...
                if (success == 1) {
                	...
                	customer1 = json.getJSONArray(TAG_CUSTOMER);
 
                    // looping through All Products
                    for (int i = 0; i < customer1.length(); i++) {
                        JSONObject c = customer1.getJSONObject(i);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Customer_model10.this, customer1List,
