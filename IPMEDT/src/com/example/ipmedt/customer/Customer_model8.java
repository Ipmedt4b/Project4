...
public class Customer_model8 extends ListActivity {
    ...
    private static String url_all_customer1 = "http://jellescheer.nl/williebrordardus/get_all_customer_m7.php";
...
//         Get listview
    ...
    class LoadAllcustomer1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Customer_model8.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Customer_model8.this, customer1List,
