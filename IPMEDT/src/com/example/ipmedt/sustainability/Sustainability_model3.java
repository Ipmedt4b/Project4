...
public class Sustainability_model3 extends ListActivity {
    ...
    ArrayList<HashMap<String, String>> sustainability1List;
 
    // url to get all products list
    private static String url_all_sustainability1 = "http://jellescheer.nl/williebrordardus/get_all_subtainability_m1.php";
 
    // JSON Node names
    private static final String TAG_SUCCESS = "success";  
    private static final String TAG_SUSTAINABILITY = "sustainability";
    ...
    // products JSONArray
    JSONArray sustainability1 = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sustainability1List = new ArrayList<HashMap<String, String>>();
 
        // Loading products in Background Thread
        new LoadAllsustainability1().execute();
...
//         Get listview
     ...
     * */
    class LoadAllsustainability1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Sustainability_model3.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_sustainability1, "GET", params);
 
            // Check your log cat for JSON reponse
            Log.d("All model: ", json.toString());
            ...
            try {
                ...
                if (success == 1) {
                	...
                	sustainability1 = json.getJSONArray(TAG_SUSTAINABILITY);
 
                    // looping through All Products
                    for (int i = 0; i < sustainability1.length(); i++) {
                        JSONObject c = sustainability1.getJSONObject(i);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Sustainability_model3.this, sustainability1List,
