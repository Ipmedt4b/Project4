...
public class Sustainability_model1 extends ListActivity {
    ...
    private static String url_all_sustainability1 = "http://jellescheer.nl/williebrordardus/get_all_subtainability.php";
 
    // JSON Node names
    private static final String TAG_SUCCESS = "success";  
    private static final String TAG_SUSTAINABILITY1 = "sustainability";
...
//         Get listview
    ...
    class LoadAllsustainability1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Sustainability_model1.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                	...
                	sustainability1 = json.getJSONArray(TAG_SUSTAINABILITY1);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Sustainability_model1.this, sustainability1List,
