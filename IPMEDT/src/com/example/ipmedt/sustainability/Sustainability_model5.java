...
public class Sustainability_model5 extends ListActivity {
    ...
    private static String url_all_sustainability1 = "http://jellescheer.nl/williebrordardus/get_all_subtainability_m3.php";
...
//    }
    ...
    class LoadAllsustainability1 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Sustainability_model5.this);
                ...
                public void run() {
                     ...
                     * */
                	 ListAdapter adapter = new SimpleAdapter(
                             Sustainability_model5.this, sustainability1List,
